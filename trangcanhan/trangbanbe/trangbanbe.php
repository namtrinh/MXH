    ...
    <div class="name">
      ...
      <div class="banbe">
        ...
        <script>
          ...
          $.ajax({
              url: 'trangcanhan/trangbanbe/timkiem_tbb.php',
              method: 'POST',
              data: {
                timkiem: timkiem,
                m_id: m_id
      ...
      function loadAllFriends(m_id) {
          $.ajax({
              url: 'trangcanhan/trangbanbe/tatcabanbe_tbb.php',
              method: 'POST',
              data: {
                m_id:m_id
              },
        ...
        <div class="modal fade" id="modal-id-banchung">
          <div class="modal-dialog">
            <div class="modal-content" style="width:400px;height:420px; border-radius:15px;margin:20vh auto">
              <div class="modal-header" style="border-bottom: 1px solid #DBDBDB;height:50px">
                <h5 class="modal-title" style="position:absolute;left:38%;text-align:center;color:black">Bạn chung</h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true" style="border:none;padding:30px;background:none;position:absolute;right:0">&times;</button>
              </div>
              <div class="modal-body" style="padding:0;overflow:auto">
                <?php 
